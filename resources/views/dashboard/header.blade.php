                ...
                <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0"
                    ...
                    <div data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-0 me-lg-2">
                        ...
                        <span class="menu-link">
                            <a href="{{route('home.page')}}"><span
                                    class="menu-title">{{__('site.dashboard')}}</span></a>
                    ...
                    <div data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-0 me-lg-2">
                        <!--begin:Menu link-->
                        <span class="menu-link">
                            <a href="{{route('order.index')}}"> <span
                                    class="menu-title">{{__('site.orders')}}</span></a>
                            <span class="menu-arrow d-lg-none"></span>
                        </span>
                        <!--end:Menu link-->
                    </div>
