                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <li class="breadcrumb-item text-muted">@yield('name')</li>
                                        <!--end::Item-->
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                                ...
                                <div class="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    {{-- <a href="{{route('send.message.whats')}}"
                                        class="btn btn-sm fw-bold bg-body btn-color-gray-700 btn-active-color-primary">{{__('site.customers')}}</a>
                                    --}}
                                    @can(['Update-Customer'])
                                    ...
                                    <a href="{{route('order.create')}}"
                                        class="btn btn-sm fw-bold btn-primary">{{__('site.add_order')}}</a>
                                    @endcan
                                    <!--end::Primary button-->
                                </div>
                                <!--end::Actions-->
                            ...
                            <div class="timeline-content mb-10 mt-n1">
                                ...
                                <div class="overflow-auto pb-5">
                                    ...
                                    <div
                                        ...
                                        <!--begin::Title-->
                                        <a class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Meeting
                                            with customer</a>
                                        <!--end::Title-->
                                        <!--begin::Label-->
                                        ...
                                        <!--end::Progress-->
                                        <!--begin::Action-->
                                        <a class="btn btn-sm btn-light btn-active-light-primary">View</a>
                                        <!--end::Action-->
                                    </div>
                                    <!--end::Record-->
                                    <!--begin::Record-->
                                    <div
                                        ...
                                        <!--begin::Title-->
                                        <a class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Project
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            ...
                                            <div class="ms-1 fw-semibold">
                                                <!--begin::Desc-->
                                                <a class="fs-6 text-hover-primary fw-bold">Finance KPI App
                                                    Guidelines</a>
                                                <!--end::Desc-->
                                                <!--begin::Number-->
