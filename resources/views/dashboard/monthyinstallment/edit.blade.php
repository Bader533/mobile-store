                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <a class="symbol symbol-50px">
                                                                <span class="symbol-label"
                                                                    style="background-image:url({{ asset($monthy->contract->order->product->images->first()->url) }});"></span>
                                                            </a>
                                                            <!--end::Thumbnail-->
                                                            <!--begin::Title-->
                                                            <div class="ms-5">
                                                                <div class="fw-bold">
                                                                    {{ $monthy->contract->order->product->product_name }}
                                                                </div>
