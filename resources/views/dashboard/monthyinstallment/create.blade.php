                            ...
                            <div class="page" id="page">
                                ...
                                <center>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4"><img src="{{asset('images/logo-contract.png')}}" alt="">
                                        </div>
                                ...
                                <hr><br>
                                <div class="content">
                                    <p class="title">عقد اتفاق على بيع جوال تقسيط</p><br>
                                    <div class="contract">
                                        ...
                                        <p>
                                            ...
                                            احمد اليازوري ، من غزة
                                            و

                                        </p>
                                        <p>يحمل الهوية رقم / (40611477) دائن</p>
                                        <p>الطرف الثاني: {{$order->customer->name}} من غزة ويحمل بطاقة رقم
                                            ({{$order->customer->id_number}})
                                            (مدين).</p>
                                        <p>الكفيل: {{$order->guarantor->name}} من غزة ويحمل رقم الهوية
                                        ...
                                        <p>الأقساط كلها مستحقة السداد؛ يحق للطرف الأول التوجه لدائرة التنفيذ لتحصيل دينه
                                            ...
                                            المتيقسة .</p>
                                        <p>4 - اتفق الطرفان على عدم العدول أو النكول على ما جاء فى هذا السند من اتفاق و
                                            التعهد بتنفيذه حسب
                                            الاصول .</p>
                                        <p>
                ...
                <div class="card card-flush py-4">
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                <!--begin::Add customer-->
                                <a onclick="printDraft()" class="btn btn-primary">{{__('site.print')}}</a>
                                <!--end::Add customer-->
                            </div>
                            <!--end::Toolbar-->
                            <!--begin::Group actions-->
