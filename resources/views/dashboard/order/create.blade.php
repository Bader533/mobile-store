                            ...
                            <div class="d-flex flex-column gap-10">
                                ...
                                <div class="fv-row">
                                    ...
                                    <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                                        data-placeholder="{{ __('site.select_option') }}" name="installment_method"
                                ...
                                <div class="fv-row">
                                    ...
                                    <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                                        data-placeholder="{{ __('site.select_option') }}" name="branch_id" id="branch_id"
                                        required>
                                        <option></option>
                            ...
                            <div class="d-flex flex-column gap-5 gap-md-7">
                                ...
                                <div class="fv-row" id="customer_order_name">
                                    ...
                                    <select name="customer_id" id="customer_id" data-control="select2"
                                        data-placeholder="{{ __('site.select_option') }}"
