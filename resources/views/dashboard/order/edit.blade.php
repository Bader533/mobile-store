                            ...
                            <div class="d-flex flex-column gap-10">
                                ...
                                <div class="fv-row">
                                    ...
                                    <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                                        ...
                                        <option value="rejected" @if ($order->status == 'rejected') selected @endif>rejected
                                        </option>
                                    ...
                                    <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                                        ...
                                        @foreach ($installments as $installment)
                                            <option value="{{ $installment->id }}"
                                                @if ($order->installment_id == $installment->id) selected @endif>{{ $installment->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="fv-row">
                                    ...
                                    <input type="date" class="form-control mb-2" name="installment_date"
                                        id="installment_date" value="{{ $order->installment_date }}" required />
                                    ...
                                    <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                                        ...
                                        @foreach ($branches as $branch)
                                            <option value="{{ $branch->id }}"
                                                @if ($order->branch_id == $branch->id) selected @endif>
                            ...
                            <div class="d-flex flex-column gap-5 gap-md-7">
                                ...
                                <div class="fv-row" id="guarantor_order_name">
                                    ...
                                    <select name="guarantor_id" id="guarantor_id" data-control="select2"
                                        ...
                                        @foreach ($customers as $customer)
                                            <option value="{{ $customer->id }}"
                                                @if ($order->guarantor_id == $customer->id) selected @endif>
                                                {{ $customer->name_en }}</option>
                                        @endforeach
                                    </select>
                                    <!--end::Select2-->
                                    ...
                                    <select name="company_name" id="company_name" data-control="select2"
                                        ...
                                        @foreach ($companies as $company)
                                            <option value="{{ $company->id }}"
                                                @if ($order->customer_id == $company->id) selected @endif>
                                ...
                                <input type="text" name="serial_number" id="serial_number" class="form-control mb-2"
                                    placeholder="{{__('site.serial_number')}}" value="{{$order->serial_number}}"
                                    required />
                                <!--end::Input-->
                            </div> --}}
                                <!--end::serial_number-->
                                                ...
                                                <td>
                                                    <div
                                                        ...
                                                        <input class="form-check-input" type="checkbox" id="product_id"
                                                            name="product_id"
                                                            @if ($product->id == $order->product_id) checked @endif
                                                            value="{{ $product->id }}" />
                                                    </div>
                                                </td>
                            ...
                            <div class="d-flex flex-column gap-5 gap-md-7">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <input type="text" name="serial_number" id="serial_number"
                                        class="form-control mb-2" placeholder="{{ __('site.serial_number') }}"
                                        value="{{ $order->serial_number }}" required />
                                    <!--end::Input-->
                                </div>
                                <!--end::serial_number-->
