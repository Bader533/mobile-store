    ...
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                ...
                @canany(['Create-Employee', 'Read-Employees', 'Create-Branch', 'Read-Branches'])
                    <div class="menu-item pt-5">
                        ...
                        <div class="menu-content">
                            <span class="menu-heading fw-bold text-uppercase fs-7">{{ __('site.hr') }}</span>
                        </div>
                        <!--end:Menu content-->
                    </div>
                @endcanany
                ...
                <!--begin:Menu item-->
                @canany(['Create-Product', 'Read-Products', 'Create-Customer', 'Read-Customers', 'Create-Order',
                    'Read-Orders', 'Create-Installment', 'Read-Installments', 'Create-Contract', 'Read-Contracts'])
                    <div class="menu-item pt-5">
                        <!--begin:Menu content-->
                        <div class="menu-content">
                            <span class="menu-heading fw-bold text-uppercase fs-7">{{ __('site.apps') }}</span>
                        </div>
                        <!--end:Menu content-->
                    </div>
                @endcanany
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            @can('Read-Contracts')
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link"
                                        @if (Auth::guard('customer')->check()) href="{{ route('contract-customer.index') }}" @else
                ...
                @canany(['Read-Trackings'])
                    <div class="menu-item pt-5">
                        <!--begin:Menu content-->
                        <div class="menu-content">
                            <span class="menu-heading fw-bold text-uppercase fs-7">{{ __('site.tracking') }}</span>
                        </div>
                        <!--end:Menu content-->
                    </div>
                @endcanany
