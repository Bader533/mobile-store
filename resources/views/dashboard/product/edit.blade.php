                        ...
                        <div class="card-body text-center pt-0">
                            ...
                            <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3"
                                ...
                                <div class="image-input-wrapper w-150px h-150px"
                                    style="background-image: url({{asset($product->images->first()->url)}})">
                                </div>
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="name" id="name" class="form-control mb-2"
                                    placeholder="{{__('site.name_en')}}" value="{{$product->name_en}}" required />
                                <!--end::Input-->
                                <!--begin::Description-->
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="name_ar" id="name_ar" class="form-control mb-2"
                                    placeholder="{{__('site.name_ar')}}" value="{{$product->name_ar}}" required />
                                <!--end::Input-->
                                <!--begin::Description-->
                                <div class="text-muted fs-7">A name is required and recommended to be unique.
                                </div>
                            ...
                            {{-- <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="serial_number" id="serial_number" class="form-control mb-2"
                                    placeholder="{{__('site.serial_number')}}" value="{{$product->serial_number}}"
                                    required />
                                <!--end::Input-->
                            </div> --}}
                            <!--end::serial_number-->
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="price" id="price" class="form-control mb-2"
                                    placeholder="{{__('site.price')}}" value="{{$product->price}}" required />
                                <!--end::Input-->
                            </div>
                            <!--end::price-->
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="note" id="note" class="form-control mb-2"
                                    placeholder="{{__('site.note')}}" value="{{$product->note}}" required />
                                <!--end::Input-->
                                <!--begin::Description-->
                                {{-- <div class="text-muted fs-7">A name is required and recommended to be unique.
                                </div> --}}
...
<script>
    function update() {
        ...
        axios.post('/product/{{$product->id}}', formData)
