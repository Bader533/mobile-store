...
<tr>
    ...
    <!--begin::Name=-->
    <td>
        <a class="text-gray-800 text-hover-primary mb-1">{{$product->product_name}}</a>
    </td>
    {{-- <td>
        <a class="text-gray-800 text-hover-primary mb-1">{{$product->name_ar}}</a>
    </td> --}}
    <!--end::Name=-->
    <!--begin::Email=-->
    ...
    <td class="text-end">
        ...
        <!--begin::More-->
        {{-- @canany(['Update-Product'])
        <a href="{{route('product.show',$product->id)}}" class="btn btn-icon btn-active-light-primary w-30px h-30px"
