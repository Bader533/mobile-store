...
@section('name',__('site.all_employee'))
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" data-kt-customer-table-filter="search" id="search_employee"
                            class="form-control form-control-solid w-250px ps-15"
                            placeholder="{{__('site.search_employee')}}" />
                    </div>
                    <!--end::Search-->
                </div>
                <!--begin::Card title-->
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        <!--begin::Add customer-->
                        <a href="{{route('employee.create')}}" class="btn btn-primary">{{__('site.add_employee')}}</a>
                        <!--end::Add customer-->
                    </div>
                    <!--end::Toolbar-->
                    <!--begin::Group actions-->
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                    ...
                    <tbody class="fw-semibold text-gray-600" id="table_employee">
                        ...
                        <tr>
                            ...
                            <!--begin::Name=-->
                            <td>
                                <a @can(['Show-Employee']) href="{{route('employee.show',$employee->id)}}" @endcan
                    ...
                    <tbody class="fw-semibold text-gray-600" id="table_employee_2">
