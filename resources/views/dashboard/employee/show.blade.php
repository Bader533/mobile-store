                    ...
                    <div class="card-body pt-15">
                        ...
                        <div class="d-flex flex-center flex-column mb-5">
                            ...
                            <div class="symbol symbol-100px symbol-circle mb-7">
                                <img src="{{asset($employee->images[0]->url)}}" alt="image" />
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Name-->
                            <a class="fs-3 text-gray-800 text-hover-primary fw-bold mb-1">{{$employee->name}}</a>
                            <!--end::Name-->
                            <!--begin::Position-->
                            <div class="fs-5 fw-semibold text-muted mb-6">{{__('site.employee')}}</div>
                            <!--end::Position-->
                        </div>
                        <!--end::Summary-->
                        ...
                        <div id="kt_customer_view_details" class="collapse show">
                            <div class="py-5 fs-6">
                                ...
                                <div class="text-gray-600">
                                    <a class="text-gray-600 text-hover-primary">{{$employee->phone}}</a>
                                </div>
                                <!--begin::Details item-->
                            </div>
                        </div>
                            ...
                            <div class="card-header border-0">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <button type="button" class="btn btn-sm btn-flex btn-light-primary"
                                        ...
                                        {{$employee->monthyInstallments->count()}}
                                    </button>
                                    <!--end::Filter-->
                                </div>
                                <!--end::Card toolbar-->
                                    ...
                                    <div id="kt_customer_details_invoices_1" class="py-0 tab-pane fade show active"
                                        ...
                                        <table id="kt_customer_details_invoices_table_1"
                                            ...
                                            <tbody class="fs-6 fw-semibold text-gray-600">
                                                ...
                                                @if (!$employee->monthyInstallments->isEmpty())
                                                @foreach ($employee->monthyInstallments as $monthy)
                                                <tr>
                                                    <td>
                                                        <a
                                    ...
                                    <div id="kt_customer_details_invoices_1" class="py-0 tab-pane fade show active"
                                        ...
                                        <table id="kt_customer_details_invoices_table_1"
                                            ...
                                            <tbody class="fs-6 fw-semibold text-gray-600">
                                                ...
                                                <tr>
                                                    <td>
                                                        <a class="text-gray-600 text-hover-primary">{{$monthy->id}}</a>
                                                    </td>
                                                    <td class="text-success">{{$monthy->name}}</td>

                                                    <td>{{$monthy->activity}}</td>
                                                    <td>{{$monthy->created_at}}</td>

                                                </tr>
                                                @endforeach
                                                @else
                                                <tr>
                                                    <td colspan="4" align="center">{{__('site.no_data_found')}}</td>
                                                </tr>
                                                @endif
                                            </tbody>
                                            <!--end::Tbody-->
