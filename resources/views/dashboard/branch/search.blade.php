...
<tr>
    ...
    <!--begin::Name=-->
    <td>
        <a class="text-gray-800 text-hover-primary mb-1">{{$branch->branch_name}}</a>
    </td>
    <!--end::Name=-->
    <!--begin::Email=-->
    <td>
    ...
    <td class="text-end">
        ...
        <!--begin::Edit-->
        <a href="{{route('branch.edit',$branch->id)}}" class="btn btn-icon btn-active-light-primary w-30px h-30px me-3"
        ...
        <!--end::Delete-->
        <!--begin::More-->
        {{-- <a href="{{route('branch.show',$branch->id)}}" class="btn btn-icon btn-active-light-primary w-30px h-30px"
