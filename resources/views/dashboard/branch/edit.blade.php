                        ...
                        <div class="card-body text-center pt-0">
                            ...
                            <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3"
                                ...
                                <div class="image-input-wrapper w-150px h-150px"
                                    style="background-image: url({{asset('images/branch/'.$branch->images[0]->name)}})">
                                </div>
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                                ...
                                <option></option>
                                <option value="1" @if ($branch->active == 1) selected="selected"
                                    @endif>{{__('site.active')}}</option>
                                <option value="0" @if ($branch->active == 0) selected="selected"
                                    @endif>{{__('site.non_active')}}</option>
                            </select>
                            <!--end::Select2-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">Set the branch status.</div>
                            <!--end::Description-->
                            <!--begin::Datepicker-->
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="name_en" id="name_en" class="form-control mb-2"
                                    placeholder="{{__('site.name_en')}}" value="{{$branch->name_en}}" required />
                                <!--end::Input-->
                                <!--begin::Description-->
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="name_ar" id="name_ar" class="form-control mb-2"
                                    placeholder="{{__('site.name_ar')}}" value="{{$branch->name_ar}}" required />
                                <!--end::Input-->
                                <!--begin::Description-->
                                <div class="text-muted fs-7">A name is required and recommended to be unique.
                                </div>
                            ...
                            <div class="mb-10 fv-row">
                                <!--begin::Label-->
                                <label class="required form-label">{{__('site.branch_name_en')}}</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="branch_name_en" id="branch_name_en" class="form-control mb-2"
                                    placeholder="{{__('site.branch_name_en')}}" value="{{$branch->branch_name_en}}"
                                    required />
                                <!--end::Input-->
                                <!--begin::Description-->
                                <div class="text-muted fs-7">A name is required and recommended to be unique.
                            ...
                            <div class="mb-10 fv-row">
                                <!--begin::Label-->
                                <label class="required form-label">{{__('site.branch_name_ar')}}</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="branch_name_ar" id="branch_name_ar" class="form-control mb-2"
                                    placeholder="{{__('site.branch_name_ar')}}" value="{{$branch->branch_name_ar}}"
                                    required />
                                <!--end::Input-->
                                <!--begin::Description-->
                                <div class="text-muted fs-7">A name is required and recommended to be unique.
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="id_number" id="id_number" class="form-control mb-2"
                                    placeholder="{{__('site.id_number')}}" value="{{$branch->id_number}}" required />
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="phone" id="phone" class="form-control mb-2"
                                    placeholder="{{__('site.phone')}}" value="{{$branch->phone}}" required />
                                <!--end::Input-->
                                <!--begin::Description-->
                                {{-- <div class="text-muted fs-7">A name is required and recommended to be unique.
                                </div> --}}
...
<script>
    function update() {
        ...
        formData.append("branch_name_ar", document.getElementById('branch_name_ar').value);
        ...
        axios.post('/branch/{{$branch->id}}', formData)
