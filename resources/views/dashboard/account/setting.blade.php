...
@section('title',__('site.setting_acount'))

@section('page_name',__('site.setting_acount'))

@section('name',__('site.setting_acount'))
    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <form id="kt_account_profile_details_form" class="form">
                    ...
                    <div class="card-body border-top p-9">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="image-input image-input-outline" data-kt-image-input="true"
                                    ...
                                    <div class="image-input-wrapper w-125px h-125px"
                                        style="background-image: url({{asset(auth()->user()->images[0]->url)}})">
                                    </div>
                        ...
                        <div class="row mb-6">
                            <!--begin::Label-->
                            <label
                                class="col-lg-4 col-form-label required fw-semibold fs-6">{{__('site.id_number')}}</label>
                            <!--end::Label-->
                            <!--begin::Col-->
        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                ...
                <!--begin::Card title-->
                <div class="card-title m-0">
                    <h3 class="fw-bold m-0">{{__('site.password')}}</h3>
                </div>
                <!--end::Card title-->
            </div>
            <!--begin::Card header-->
...
<script>
    ...
    function updatePassword() {
        ...
        formData.append("_method", "PUT");
        axios.post('/setting/password', formData)
        .then(function (response) {
        window.location.href = '/setting';
        toastr.success(response.data.message);
