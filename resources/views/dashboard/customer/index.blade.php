...
@section('name',__('site.all_customer'))
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" data-kt-customer-table-filter="search" id="search_customer"
                            class="form-control form-control-solid w-250px ps-15"
                            placeholder="{{__('site.search_customer')}}" />
                    </div>
                    <!--end::Search-->
                </div>
                <!--begin::Card title-->
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        <!--begin::Add customer-->
                        <a href="{{route('customer.create')}}" class="btn btn-primary">{{__('site.add_customer')}}</a>
                        <!--end::Add customer-->
                    </div>
                    <!--end::Toolbar-->
                    <!--begin::Group actions-->
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">{{__('site.name_en')}}</th>
                            ...
                            <th class="min-w-125px">{{__('site.created_by')}}</th>
                    ...
                    <!--end::Table head-->
                    <!--begin::Table body-->
                    <tbody class="fw-semibold text-gray-600" id="table_customer">
                        ...
                        <tr>
                            ...
                            <!--begin::Name=-->
                            <td>
                                <a @can(['Show-Customer']) href="{{route('customer.show',$customer->id)}}" @endcan
                                    class="text-gray-800 text-hover-primary mb-1">{{$customer->customer_name}}</a>
                            </td>
                            <!--end::Name=-->
                            <!--begin::Email=-->
                            <td>
                                <a class="text-gray-600 text-hover-primary mb-1">{{$customer->id_number}}</a>
                            </td>
                            <!--end::Email=-->
                            <!--begin::Company=-->
                    ...
                    <tbody class="fw-semibold text-gray-600" id="table_customer_2">
