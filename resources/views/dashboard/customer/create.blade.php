                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="place_issue_of_id" id="place_issue_of_id"
                                    class="form-control mb-2" placeholder="{{__('site.place_issue_of_id')}}" value=""
                                    required />
                                <!--end::Input-->
                            </div>
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                                ...
                                <option></option>
                                <option value="1">{{__('site.is_company')}}</option>
                                <option value="0" selected="selected">{{__('site.is_not_company')}}</option>
                            </select>
                            <!--end::Select2-->
                            <!--begin::Description-->
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="mother_name" id="mother_name" class="form-control mb-2"
                                    placeholder="{{__('site.mother_name')}}" value="" required />
                                <!--end::Input-->
                                <!--begin::Description-->
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="address" id="address" class="form-control mb-2"
                                    placeholder="{{__('site.address')}}" value="" required />
                                <!--end::Input-->
                                <!--begin::Description-->
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="phone" id="phone" class="form-control mb-2"
                                    placeholder="970 599 999 999" value="" required />
                                <!--end::Input-->
                                <!--begin::Description-->
                                {{-- <div class="text-muted fs-7">A name is required and recommended to be unique.
                                </div> --}}
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="career" id="career" class="form-control mb-2"
                                    placeholder="{{__('site.career')}}" value="" required />
                                <!--end::Input-->
                            </div>
                            <!--end::career-->
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="place_of_work" id="place_of_work" class="form-control mb-2"
                                    placeholder="{{__('site.place_of_work')}}" value="" required />
                                <!--end::Input-->
                            </div>
                            <!--end::place_of_work-->
                        </div>
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="id_number" id="id_number" class="form-control mb-2"
                                    placeholder="{{__('site.id_number')}}" value="" required />
                                <!--end::Input-->
                            </div>
                            <!--end::id_number-->
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="place_of_birth" id="place_of_birth" class="form-control mb-2"
                                    placeholder="{{__('site.place_of_birth')}}" value="" required />
                                <!--end::Input-->
                            </div>
                            <!--end::place_of_birth-->
...
<script>
    function store() {
        ...
        // const hasPermission =
        // document.getElementById('kt_ecommerce_add_product_status_select');

        // if (hasPermission.getAttribute("data-has-permission") === "undefined") {
        // console.log('undefined');
        //  }else{
        //     console.log('defined');
        //  }

        const inputElement =document.getElementById('kt_ecommerce_add_product_status_select');
        ...
        if (inputElement && inputElement.hasAttribute('data-has-permission')) {
