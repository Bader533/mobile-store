...
@section('name', __('site.dashboard'))
                    ...
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-header rounded bgi-no-repeat bgi-size-cover bgi-position-y-top bgi-position-x-center align-items-start h-250px"
                            ...
                            <h3 class="card-title align-items-start flex-column text-white pt-15">
                                <span class="fw-bold fs-2x mb-3">{{ __('site.home') }}</span>
                            </h3>
                            <!--end::Title-->
                        </div>
                        <!--end::Heading-->
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                            ...
                                            <div class="m-0">
                                                <!--begin::Number-->
                                                <span
                                                    class="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">{{ $contracts->count() }}</span>
                                                <!--end::Number-->
                                                <!--begin::Desc-->
                                                <span
                                                    class="text-gray-500 fw-semibold fs-6">{{ __('site.contracts') }}</span>
                                                <!--end::Desc-->
                                            </div>
                                            <!--end::Stats-->
                                        </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                            ...
                                            <div class="m-0">
                                                <!--begin::Number-->
                                                <span
                                                    class="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">{{ $priceSum }}</span>
                                                <!--end::Number-->
                                                <!--begin::Desc-->
                                                <span
                                                    class="text-gray-500 fw-semibold fs-6">{{ __('site.total_value_contract') }}</span>
                                                <!--end::Desc-->
                                            </div>
                                            <!--end::Stats-->
                                        </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                            ...
                                            <div class="m-0">
                                                <!--begin::Number-->
                                                <span
                                                    class="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">{{ $totalOrder }}</span>
                                                <!--end::Number-->
                                                <!--begin::Desc-->
                                                <span
                                                    class="text-gray-500 fw-semibold fs-6">{{ __('site.total_order_approved') }}</span>
                                                <!--end::Desc-->
                                            </div>
                                            <!--end::Stats-->
                                        </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                            ...
                                            <div class="m-0">
                                                ...
                                                <!--begin::Desc-->
                                                <span
                                                    class="text-gray-500 fw-semibold fs-6">{{ __('site.customer') }}</span>
                                                <!--end::Desc-->
                                            </div>
                                            <!--end::Stats-->
                                        </div>
                        ...
                        <div class="card-header pt-5">
                            ...
                            <div class="card-title d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin::Amount-->
                                    <span
                                        class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2">{{ $monthy->sum('price') }}</span>
                                    <!--end::Amount-->
                                </div>
                                <!--end::Info-->
                                <!--begin::Subtitle-->
                                <span
                                    class="text-gray-400 pt-1 fw-semibold fs-6">{{ __('site.installments_payable') }}</span>
                                <!--end::Subtitle-->
                            </div>
                            <!--end::Title-->
                        </div>
                        ...
                        <div class="card-body pt-2 pb-4 d-flex flex-wrap align-items-center">
                            ...
                            <div class="d-flex flex-column content-justify-center flex-row-fluid">
                                ...
                                <div class="d-flex fw-semibold align-items-center">
                                    ...
                                    <!--end::Bullet-->
                                    <!--begin::Label-->
                                    <div class="text-gray-500 flex-grow-1 me-4">{{ __('site.unpaid') }}</div>
                                    <!--end::Label-->
                                    <!--begin::Stats-->
                                    <div class="fw-bolder text-gray-700 text-xxl-end">&#8362;{{ $waiting }}
                                    </div>
                                    <!--end::Stats-->
                                </div>
                                <!--end::Label-->
                                ...
                                <div class="d-flex fw-semibold align-items-center my-3">
                                    ...
                                    <!--end::Bullet-->
                                    <!--begin::Label-->
                                    <div class="text-gray-500 flex-grow-1 me-4">{{ __('site.paidup') }}</div>
                                    <!--end::Label-->
                                    <!--begin::Stats-->
                                    <div class="fw-bolder text-gray-700 text-xxl-end">
                                        &#8362;{{ $paidOnTime + $paidLate + $paidEarly }}
                                    </div>
                                    <!--end::Stats-->
                                </div>
                                <!--end::Label-->
                                ...
                                <div class="d-flex fw-semibold align-items-center">
                                    ...
                                    <!--end::Bullet-->
                                    <!--begin::Label-->
                                    <div class="text-gray-500 flex-grow-1 me-4">{{ __('site.others') }}</div>
                                    <!--end::Label-->
                                    <!--begin::Stats-->
                        ...
                        <div class="card-header pt-5">
                            ...
                            <div class="card-title d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin::Amount-->
                                    <span
                                        class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2">{{ $paidOnTime + $paidLate + $paidEarly }}</span>
                                    <!--end::Amount-->
                                </div>
                                <!--end::Info-->
                                <!--begin::Subtitle-->
                                <span
                                    class="text-gray-400 pt-1 fw-semibold fs-6">{{ __('site.Paid_installments') }}</span>
                                <!--end::Subtitle-->
                            </div>
                            <!--end::Title-->
                        </div>
                        ...
                        <div class="card-body pt-2 pb-4 d-flex align-items-center">
                            ...
                            <div class="d-flex flex-column content-justify-center w-100">
                                ...
                                <div class="d-flex fs-6 fw-semibold align-items-center">
                                    ...
                                    <!--end::Bullet-->
                                    <!--begin::Label-->
                                    <div class="text-gray-500 flex-grow-1 me-4">{{ __('site.paidontime') }}</div>
                                    <!--end::Label-->
                                    <!--begin::Stats-->
                                    <div class="fw-bolder text-gray-700 text-xxl-end">&#8362;{{ $paidOnTime }}</div>
                                    <!--end::Stats-->
                                </div>
                                <!--end::Label-->
                                <!--begin::Label-->
                                <div class="d-flex fs-6 fw-semibold align-items-center my-3">
                                    ...
                                    <!--end::Bullet-->
                                    <!--begin::Label-->
                                    <div class="text-gray-500 flex-grow-1 me-4">{{ __('site.paidearly') }}</div>
                                    <!--end::Label-->
                                    <!--begin::Stats-->
                                    <div class="fw-bolder text-gray-700 text-xxl-end">&#8362;{{ $paidEarly }}</div>
                                    <!--end::Stats-->
                                </div>
                                <!--end::Label-->
                                <!--begin::Label-->
                                <div class="d-flex fs-6 fw-semibold align-items-center">
                                    ...
                                    <!--end::Bullet-->
                                    <!--begin::Label-->
                                    <div class="text-gray-500 flex-grow-1 me-4">{{ __('site.paidlate') }}</div>
                                    <!--end::Label-->
                                    <!--begin::Stats-->
                                    <div class="fw-bolder text-gray-700 text-xxl-end">&#8362;{{ $paidLate }}</div>
                                    <!--end::Stats-->
                                </div>
                                <!--end::Label-->
                            </div>
                    ...
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-header pt-7">
                            ...
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold text-dark">{{ __('site.products_ordered') }}</span>
                            ...
                            <div class="card-toolbar">
                                <a href="{{ route('order.create') }}"
                                    class="btn btn-sm btn-light">{{ __('site.add_order') }}</a>
                            </div>
                            <!--end::Toolbar-->
                        </div>
                        <!--end::Header-->
                                    ...
                                    <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                        ...
                                        <div class="d-flex flex-stack mb-3">
                                            ...
                                            <div class="me-3">
                                                ...
                                                <!--begin::Title-->
                                                <a
                                                    class="text-gray-800 text-hover-primary fw-bold">{{ $order->product->product_name }}</a>
                                                <!--end::Title-->
                                            </div>
                                            <!--end::Wrapper-->
                                        </div>
                                        ...
                                        <div class="d-flex flex-stack">
                                            ...
                                            <span class="text-gray-400 fw-bold">To:
                                                <a href="{{ route('customer.show', $order->customer->id) }}"
                                                    class="text-gray-800 text-hover-primary fw-bold">{{ $order->customer->customer_name }}</a></span>
                                            <!--end::Name-->
                                            <!--begin::Label-->
                ...
                <div class="col-xl-8">
                    ...
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-header pt-7">
                            <!--begin::Title-->
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold text-dark">{{ __('site.order') }}</span>
                            ...
                            <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                ...
                                <thead>
                                    ...
                                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                        <th class=" pe-3 min-w-100px">{{ __('site.product') }}</th>
                                        <th class=" pe-3 min-w-150px">{{ __('site.customer') }}</th>
                                        <th class=" pe-3 min-w-100px">{{ __('site.guarantor') }}</th>
                                        <th class=" pe-3 min-w-100px">{{ __('site.presenter') }}</th>
                                        <th class=" pe-3 min-w-50px">{{ __('site.status') }}</th>
                                    </tr>
                                    <!--end::Table row-->
                                </thead>
                                <!--end::Table head-->
                                    ...
                                    @if (!$orders->isEmpty())
                                        @foreach ($orders as $order)
                                            <tr>
                                                ...
                                                <td>
                                                    <a
                                                        class="text-dark text-hover-primary">{{ $order->product->product_name }}</a>
                                                </td>
                                                <!--end::Item-->
                                                <!--begin::Product ID-->
                                                ...
                                                <td>
                                                    ...
                                                    @if ($order->installment->id == 2 || $order->installment->id == 4)
                                                        {{ $order->guarantor->customer_name }}
                                                    @elseif ($order->installment->id == 3 || $order->installment->id == 5)
                                                        --
                                                    @endif
...
@section('js')
    ...
    <script>
        function buttonHeader() {
            const button = document.getElementById('home_index');
