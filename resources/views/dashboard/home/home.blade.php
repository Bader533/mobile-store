                                ...
                                <div class="col-6">
                                    ...
                                    <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                        ...
                                        <div class="m-0">
                                            ...
                                            <!--end::Number-->
                                            <!--begin::Desc-->
                                            <span class="text-gray-500 fw-semibold fs-6">{{__('site.contracts')}}</span>
                                            <!--end::Desc-->
                                        </div>
                                        <!--end::Stats-->
                                    </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                        ...
                                        <div class="m-0">
                                            ...
                                            <!--end::Number-->
                                            <!--begin::Desc-->
                                            <span class="text-gray-500 fw-semibold fs-6">{{__('site.customer')}}</span>
                                            <!--end::Desc-->
                                        </div>
                                        <!--end::Stats-->
                                    </div>
                    ...
                    <div class="card-header pt-5">
                        ...
                        <div class="card-title d-flex flex-column">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <!--end::Currency-->
                                <!--begin::Amount-->
                                <span class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2">{{$monthy->sum('price')}}</span>
                                <!--end::Amount-->
                                <!--begin::Badge-->
                            ...
                            <!--end::Info-->
                            <!--begin::Subtitle-->
                            <span class="text-gray-400 pt-1 fw-semibold fs-6">{{__('site.installments_payable')}}</span>
                            <!--end::Subtitle-->
                        </div>
                        <!--end::Title-->
                    </div>
                    ...
                    <div class="card-body pt-2 pb-4 d-flex flex-wrap align-items-center">
                        ...
                        <div class="d-flex flex-column content-justify-center flex-row-fluid">
                            ...
                            <div class="d-flex fw-semibold align-items-center">
                                ...
                                <!--end::Label-->
                                <!--begin::Stats-->
                                <div class="fw-bolder text-gray-700 text-xxl-end">&#8362;{{$waiting->sum('price')}}
                                </div>
                                <!--end::Stats-->
                            </div>
                            <!--end::Label-->
                            ...
                            <div class="d-flex fw-semibold align-items-center my-3">
                                ...
                                <!--end::Label-->
                                <!--begin::Stats-->
                                <div class="fw-bolder text-gray-700 text-xxl-end">&#8362;{{$paidOnTime + $paidLate +
                                    $paidEarly}}</div>
                                <!--end::Stats-->
                            </div>
                            <!--end::Label-->
                    ...
                    <div class="card-header pt-5">
                        ...
                        <div class="card-title d-flex flex-column">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <!--end::Currency-->
                                <!--begin::Amount-->
                                <span class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2">{{$paidOnTime + $paidLate +
                                    $paidEarly}}</span>
                                <!--end::Amount-->
                            </div>
                            <!--end::Info-->
                            <!--begin::Subtitle-->
                            <span class="text-gray-400 pt-1 fw-semibold fs-6">{{__('site.Paid_installments')}}</span>
                            <!--end::Subtitle-->
                        </div>
                        <!--end::Title-->
                    </div>
                        ...
                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                            ...
                            <tbody class="fw-bold text-gray-600">
                                ...
                                <tr>
                                    <!--begin::Item-->
                                    <td>
                                        <a class="text-dark text-hover-primary">{{$order->product->product_name}}</a>
                                    </td>
                                    <!--end::Item-->
                                    <!--begin::Product ID-->
